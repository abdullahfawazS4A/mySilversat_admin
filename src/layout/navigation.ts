  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Package,
        hint: 'المنتجات وفئاتها وأسعارها',
      },
      {
        path: '/stock',
        label: 'مخزن الكارتات',
      ...
      },
      {
        ...
        label: 'الوكلاء',
        icon: Store,
        hint: 'غير مربوطة بالـ API — ماكو endpoints للوكلاء',
      },
    ],
  },
  {
    ...
    items: [
      {
        ...
        icon: Gift,
        hint: 'غير مربوطة بالـ API — ماكو endpoints للسحوبات',
      },
      {
        path: '/coupons',
        label: 'الكوبونات',
        icon: Ticket,
        hint: 'غير مربوطة بالـ API — ماكو endpoints للكوبونات',
      },
    ],
  },
  {
