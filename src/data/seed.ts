...
export const ADMIN_ROLES: AdminRole[] = [
  {
    key: 'owner',
    nameAr: 'مالك النظام',
    descriptionAr: 'صلاحية كاملة على كل شيء، بما فيها المستخدمين الإداريين والإعدادات.',
    permissions: [
      'dashboard.view',
      'users.view',
      'users.edit',
  ...
  },
  {
    key: 'operations',
    nameAr: 'العمليات',
    descriptionAr: 'يدير المباريات والتوقعات والسحوبات والاشتراكات، بدون إعدادات النظام.',
    permissions: [
      'dashboard.view',
      'users.view',
      'users.edit',
  ...
  },
  {
    key: 'content',
    nameAr: 'المحتوى',
    descriptionAr: 'يحرر العروض والسلايدات والفيديوهات والأسئلة الشائعة ويرسل الإشعارات.',
    permissions: [
      'dashboard.view',
      'matches.view',
      'predictions.view',
  ...
  },
  {
    key: 'support',
    nameAr: 'الدعم',
    descriptionAr: 'يبحث عن المشتركين وأجهزتهم ويطّلع على سجل التجديد، بدون تعديل مالي.',
    permissions: [
      'dashboard.view',
      'users.view',
      'users.edit',
  ...
  },
  {
    key: 'viewer',
    nameAr: 'مشاهدة فقط',
    descriptionAr: 'اطّلاع على كل الشاشات بدون أي تعديل.',
    permissions: [
      'dashboard.view',
      'users.view',
      'devices.view',
...
export const ADMIN_USERS: AdminUser[] = [
  ...
  },
  {
    ...
    username: 'ops.mustafa',
    phone: '07700000002',
    role: 'operations',
    active: true,
    createdAt: at(-300, 10),
    lastLoginAt: at(-1, 20, 40),
    governorateIds: [],
  },
  {
    id: 'adm_3',
    fullName: 'نور الهدى كريم',
    username: 'content.noor',
    phone: '07700000003',
    role: 'content',
    active: true,
    createdAt: at(-210, 11),
    lastLoginAt: at(-2, 13, 5),
    governorateIds: [],
  },
  {
    id: 'adm_4',
    fullName: 'حسن الطائي',
    username: 'support.hasan',
    phone: '07700000004',
    role: 'support',
    active: true,
    createdAt: at(-160, 9),
    lastLoginAt: at(0, 9, 30),
    governorateIds: ['gov_nnw', 'gov_erb', 'gov_dhk'],
  },
  {
    id: 'adm_5',
    fullName: 'زينب عباس',
    username: 'support.zainab',
    phone: '07700000005',
    role: 'support',
    active: false,
    createdAt: at(-120, 9),
    lastLoginAt: at(-45, 15, 0),
    governorateIds: ['gov_bsr', 'gov_msn'],
  },
];
